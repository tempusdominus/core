module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            target: {
                files: {
                    'build/js/bootstrap-datetimepicker.min.js': 'src/js/eonasdan-bootstrap-datetimepicker.js'
                }
            },
            options: {
                mangle: true,
        ...
        babel: {
            ...
            dist: {
                ...
                files: {
                    'build/js/eonasdan-bootstrap-datetimepicker.js': 'build/js/eonasdan-bootstrap-datetimepicker.js'
                }
            }
        },
        concat: {
